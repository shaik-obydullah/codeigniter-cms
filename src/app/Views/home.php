    ...
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-12">
            <button data-filter="all"
                class="project-filter-btn px-4 py-2 rounded-full text-sm font-medium transition bg-lime-500 text-gray-900">All</button>
            <?php if (!empty($categories)): ?>
            <?php foreach ($categories as $cat): ?>
            <button data-filter="<?= esc($cat->name) ?>"
                class="project-filter-btn px-4 py-2 rounded-full text-sm font-medium transition bg-gray-700 text-white hover:bg-gray-600"><?= esc($cat->name) ?></button>
            <?php endforeach; ?>
            <?php endif; ?>
            <?php if (!empty($tags)): ?>
            <?php foreach ($tags as $tag): ?>
            <button data-filter="<?= esc($tag->name) ?>"
                class="project-filter-btn px-4 py-2 rounded-full text-sm font-medium transition bg-gray-700 text-white hover:bg-gray-600"><?= esc($tag->name) ?></button>
            <?php endforeach; ?>
            <?php endif; ?>
        </div>
...
<section id="blog" class="bg-gray-800 py-20">
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-12">
            <button data-filter="all"
                class="article-filter-btn px-4 py-2 rounded-full text-sm font-medium transition bg-lime-500 text-gray-900">All</button>
            <?php if (!empty($categories)): ?>
            <?php foreach ($categories as $cat): ?>
            <button data-filter="<?= esc($cat->name) ?>"
                class="article-filter-btn px-4 py-2 rounded-full text-sm font-medium transition bg-gray-700 text-white hover:bg-gray-600"><?= esc($cat->name) ?></button>
            <?php endforeach; ?>
            <?php endif; ?>
        </div>
