        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                    ...
                    <a href="<?= site_url('/admin/projects/create') ?>" class="flex items-center gap-2 bg-lime-500 text-gray-900 font-semibold px-4 py-2.5 rounded-lg hover:bg-lime-400 transition text-sm shrink-0"><i class="fas fa-plus"></i> New Project</a>
                </div>
                                ...
                                <tr class="hover:bg-gray-700/50 transition">
                                    ...
                                    <td class="px-5 py-4 text-right">
                                        <div class="flex items-center justify-end gap-1">
                                            <a href="<?= site_url('/admin/projects/' . $project->id . '/edit') ?>" class="p-1.5 text-gray-500 hover:text-white hover:bg-gray-700 rounded-lg transition" title="Edit"><i class="fas fa-pen text-sm"></i></a>
                                            <form method="post" action="<?= site_url('/admin/projects/' . $project->id . '/delete') ?>" onsubmit="return confirm('Are you sure?')" class="inline">
                                                <?= csrf_field() ?>
