<?= view('admin/layout/header', ['pageTitle' => $pageTitle, 'currentPage' => 'projects', 'unreadCount' => $unreadCount, 'user' => $user, 'extraHead' => '<script src="https://cdn.jsdelivr.net/npm/sortablejs@1.15.6/Sortable.min.js"></script>']) ?>
